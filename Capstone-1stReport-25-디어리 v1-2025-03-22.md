...
| 항목 | 내용 |
|:---  |---  |
| (1) 요구사항 정의 | **1.기능 명세 (API 중심)** <br> ![API user and quiz](https://github.com/dear-yy/CapstoneDesignProject/blob/main/image/API_battle.png) <br> ![API battle](https://github.com/dear-yy/CapstoneDesignProject/blob/main/image/API_battle.png) <br> ![API ranking](https://github.com/dear-yy/CapstoneDesignProject/blob/main/image/API_ranking.png) <br> **2. Entity-Relationship Diagram** ![ERD](https://github.com/dear-yy/CapstoneDesignProject/blob/main/image/ERD.jpg)
